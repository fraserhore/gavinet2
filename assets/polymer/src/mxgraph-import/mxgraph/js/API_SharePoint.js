...
function createListItem(properties, success, failure) {
...
// properties: json object with item properties to be updated
function UpdateListItem(itemId, properties) {
	if(itemId)
	{
...
// failure: The function to execute if the call fails
function deleteListItemOld(itemId, success, failure) {
...
function deleteItemReturn(itemId, success, failure) {
...
function getItemWithId(itemId, success, error) {
	$.ajax({
...
function getFullItemFieldById(itemId, success, error) {
	$.ajax({
		url: webAbsoluteUrl + "/_api/Web/Lists/getByTitle('" + listName + "')/items('" + itemId + "')",
		type: "GET",
		contentType: "application/json;odata=verbose",
...
function getItemProperty(itemId, property, success, error) {
	$.ajax({
...
function getItemByField(fieldName, fieldQueryParameter, success, error) {
	$.ajax({
...
function getListItemByField(fieldName, fieldQueryParameter, success, error) {
	$.ajax({
...
function getAllItems(viewFields, filter, rowlimit, orderbyfield, success, error) {
